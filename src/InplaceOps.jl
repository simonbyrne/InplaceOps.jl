...
# extend Base.broadcast! needs to be extended to work with numbers.

badd!{N}(::Type{Inplace{N}}, As::Union(Array,BitArray)...) = broadcast!(+,As[N],As...)
bsub!{N}(::Type{Inplace{N}}, As::Union(Array,BitArray)...) = broadcast!(-,As[N],As...)
bmul!{N}(::Type{Inplace{N}}, As::Union(Array,BitArray)...) = broadcast!(*,As[N],As...)
bldiv!{N}(::Type{Inplace{N}}, As::Union(Array,BitArray)...) = broadcast!(\,As[N],As...)
brdiv!{N}(::Type{Inplace{N}}, As::Union(Array,BitArray)...) = broadcast!(/,As[N],As...)

badd!(O::Union(Array,BitArray), As::Union(Array,BitArray)...) = broadcast!(+,O,As...)
bsub!(O::Union(Array,BitArray), As::Union(Array,BitArray)...) = broadcast!(-,O,As...)
bmul!(O::Union(Array,BitArray), As::Union(Array,BitArray)...) = broadcast!(*,O,As...)
bldiv!(O::Union(Array,BitArray), As::Union(Array,BitArray)...) = broadcast!(\,O,As...)
brdiv!(O::Union(Array,BitArray), As::Union(Array,BitArray)...) = broadcast!(/,O,As...)
